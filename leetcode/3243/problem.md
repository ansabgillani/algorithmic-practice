...
**Explanation:**
- After adding the road from 2 to 4, the shortest path length from 0 to 4 is 3.
- After adding the road from 0 to 2, the shortest path length from 0 to 4 is 2.
- After adding the road from 0 to 4, the shortest path length from 0 to 4 is 1.
...
**Explanation:**
- After adding the road from 0 to 3, the shortest path length from 0 to 3 is 1.
- After adding the road from 0 to 2, the shortest path length from 0 to 3 remains 1.
